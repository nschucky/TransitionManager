...
class DemoButton: UIButton {
    ...
    init(title: String, action: () -> Void) {
        ...
        self.action = action
        setTitle(title, for: [])
        setTitleColor(UIColor(red: 230.0/255.0, green: 172.0/255.0, blue: 39.0/255.0, alpha: 1), for: [])
        ...
        addTarget(self, action: #selector(DemoButton.actionHandler(sender:)), for: .touchUpInside)
    }
